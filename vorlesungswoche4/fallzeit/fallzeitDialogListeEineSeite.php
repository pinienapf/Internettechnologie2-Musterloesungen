...
<body>
	...
	<form action="../../vorlesungswoche3 - Kopie/fallzeit/fallzeitDialogListeEineSeite.php" method="post">	
		<p>
	...
	<p><a href="../../vorlesungswoche3 - Kopie/fallzeit/fallzeitDialogListeEineSeite.php">Neue Berechnung?</a></p>
	
	<?php 
			// Einbinden einer php-Datei, die Code enthält, der sonst redundant wäre.
			include '../../vorlesungswoche3 - Kopie/fallzeit/fallzeitTabelle_inc.php'; 
