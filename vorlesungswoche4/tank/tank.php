...
<body>
	...
	<form action="../../vorlesungswoche3 - Kopie/tank/tank.php" method="post">	
		<p>
	...
	<p><a href="../../vorlesungswoche3 - Kopie/tank/tank.php">Neue Berechnung?</a></p>
	
	<?php 
			// Einbinden einer php-Datei, die Code enthält, der sonst redundant wäre.
			include '../../vorlesungswoche3 - Kopie/tank/tankTabelle_inc.php'; 
